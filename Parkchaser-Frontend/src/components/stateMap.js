...
class Map extends Component {
	...
	componentDidMount() {
		var index = statename.findIndex(obj => obj.abbreviation === this.props.state);
		var temp = {
			lat: statename[index].latitude,
			lng: statename[index].longitude
		}
		//Set data
		this.setState({
			center: temp
		...
		places = places.filter((e) => {
			return this.checkAddressMatch(e.address, this.props.state)
		})
